...
namespace HexxagonVisualizer
{
    class ClientClass
    {
        ...
        public ClientClass()
        {
            ...
            MyId = Constants.ID_JUST_VISUALISATOR_PLAY;
        }
        ...
        public Tuple<bool, int> FirstConnection_ChangeMyId()
        {
            ...
            while (true)
            {
                ...
                {
                    MyId = Convert.ToInt32(dataRec[1]);
                    break;
                }
            ...
            if (dataRec[1] == ConstantsLibrary.Constants.ID_EXTRA_GET_OUT) //Лишний, вырубиться
            {
                Environment.Exit(0);
            }

            //Измененить идентификатора
            change = true;
        ...
        {
            Console.WriteLine(ConstantsLibrary.Constants.SOMETHING_WRONG_MESS[ConstantsLibrary.Constants.SOMETHING_WRONG_CONNECTION_FAIL]);
            Environment.Exit(0);
        }
